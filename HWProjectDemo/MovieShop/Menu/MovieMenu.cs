...
{
    class MovieMenu : IMenu
    {
        public int PrintMenu()
        {
            int choice = 0;

            string[] names = Enum.GetNames(typeof(MovieMenuOption));
            int[] values = (int[])Enum.GetValues(typeof(MovieMenuOption));

            int length = names.Length;
            Console.WriteLine("This is the Movie Menu");

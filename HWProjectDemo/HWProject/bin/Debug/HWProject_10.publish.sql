...
CREATE TABLE [dbo].[MovieCast] (
    ...
    CONSTRAINT [PK_MovieCast] PRIMARY KEY CLUSTERED ([Character] ASC, [Cast_Id] ASC, [Movie_Id] ASC)
);
...
CREATE TABLE [dbo].[User] (
    ...
    [LockoutEndDate]       DATETIMEOFFSET (7) NOT NULL,
...
ALTER TABLE [dbo].[MovieCast]
    ADD CONSTRAINT [FK_MovieCast_Movie] FOREIGN KEY ([Movie_Id]) REFERENCES [dbo].[Movie] ([Id]);
...
GO
ALTER TABLE [dbo].[MovieCast]
    ADD CONSTRAINT [FK_MovieCast_Cast] FOREIGN KEY ([Cast_Id]) REFERENCES [dbo].[Cast] ([Id]);
